...
* Turn off battery optimization, auto sleeping, or any other battery restrictions to prevent apps from being killed. See [**DontKillMyApp**](#dontkillmyapp-dontkillmyapp-make-apps-work-by-urbandroid-team-urbandroidteam-petr-nalevka-urbandroid) for more information.
...
* **Google Play**: <https://play.google.com/store/apps/details?id=net.christianbeier.droidvnc_ng>.
